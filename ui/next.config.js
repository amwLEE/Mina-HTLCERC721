...
const nextConfig = {
   ...
   */
  basePath: isProd ? '/Mina-HTLCERC721': '', // update if your repo name changes for npm run deploy to work successfully
  assetPrefix: isProd ? '/Mina-HTLCERC721': '', // update if your repo name changes for npm run deploy to work successfully

  ...
  if (state.hasBeenSetup && state.accountExists) {
    ...
    mainContent = (
      <div style={{ justifyContent: 'center', alignItems: 'center' }}>
        ...
        <ButtonRow buttonName="newContract" onClick={onSendTransaction} inputFields={[{ type: 'text', placeholder: 'receiver' }, { type: 'number', placeholder: 'hashlock' }, { type: 'number', placeholder: 'timelock' }, { type: 'text', placeholder: 'tokenContract' }, { type: 'number', placeholder: 'tokenId' }]} />
